...
imbr=noise(im,40)
#viewimage(rotation(im,45,ech=1,alpha=0.5,clip=True))

viewimage(imbr)
viewimage(get_gau_ker(2))
viewimage(filtre_lineaire(imbr,get_gau_ker(2)))
viewimage(filtre_lineaire(imbr,get_cst_ker(2)))

#viewimage(median_filter(imbr,r=2))
